...
var BugListComponent = (function () {
    ...
    BugListComponent.prototype.getUpdatesBugs = function () {
        var _this = this;
        this.bugService.changedListener()
            .subscribe(function (updatedBug) {
            var bugIndex = _this.bugs.map(function (index) { return index.id; }).indexOf(updatedBug['id']); // get index of the updated bug in the local array 
